    ...
    def __init__(self):
        ...
        self.advanced_parameter_list: List[AdvancedParameter] = [
            AdvancedParameter(1, 1, 0, "Sound A Timbre Type",
                              ...
                              ParameterType.COMBO, ["Melody", "Drum", "Piano", "Versatile"]),
            AdvancedParameter(2, 21, 0, "Sound B Timbre Type",
                              "Timbre type of Sound B: melody/drum/piano/versatile (hex-layer). Sound B is utilized for various supplementary events, such as note-off or double-stop effects, depending on the specific tone",
                              ParameterType.COMBO, ["Melody", "Drum", "Piano", "Versatile"]),
            AdvancedParameter(3, 2, 0, "Sound A Wavetable",
                              "Wavetable of Sound A. Sound A is dedicated to playing note-on events, providing the primary tone when a note is initiated.",
                              ParameterType.COMBO, [str(i) for i in range(901)]),
            AdvancedParameter(4, 22, 0, "Sound B Wavetable",
                              "Wavetable of Sound B. Sound B is utilized for various supplementary events, such as note-off or double-stop effects, depending on the specific tone",
                              ParameterType.COMBO, [str(i) for i in range(901)]),
            AdvancedParameter(5, 114, 0, "Monophonic Mode",
            ...
            AdvancedParameter(7, 107, 0, "Portamento Time",
                              ...
                              ParameterType.KNOB, [0, 127]),
            AdvancedParameter(8, 4, 0, "Velocity to Cutoff",
                              "Controls how velocity affects the filter cutoff (certain wavetables only).",
                              ParameterType.KNOB, [0, 127]),
            AdvancedParameter(9, 41, 0, "Sound B for Note-off",
                              ...
                              ParameterType.COMBO, ["OFF", "ON"]),
            AdvancedParameter(10, 42, 0, "Note-off velocity",
                              "This refers to how the speed at which you press and release a key affects the velocity of Sound B.",
                              ParameterType.COMBO,
                              ["Note-off Velocity", "Note-on Velocity", "Minimum of Both", "Unknown"]),
            AdvancedParameter(11, 115, 0, "Sound B for Double-stop",
