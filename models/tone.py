    ...
    def __init__(self):
        ...
        self.advanced_parameter_list: List[AdvancedParameter] = [
            ...
            AdvancedParameter(4, 22, 0, "Sound B Wavetable",
                              ...
                              ParameterType.COMBO, [str(i) for i in range(901)]),
            AdvancedParameter(5, 41, 0, "Sound B for Note-off",
            ...
            AdvancedParameter(6, 42, 0, "Note-off velocity",
            ...
            AdvancedParameter(7, 115, 0, "Sound B for Double-stop",
                              ...
                              ParameterType.COMBO, ["OFF", "ON"]),
            AdvancedParameter(8, 114, 0, "Monophonic Mode",
                              ...
                              ParameterType.COMBO, ["OFF", "ON"]),
            AdvancedParameter(9, 116, 0, "Portamento",
