...
dsp_effects_tuple: tuple = (
    ...
    DspEffect(19, "Delay", "Delays the input signal and feeds it back to create a repeating effect.", [
        DspParameter(12, "Delay Time", "Adjusts the total delay time in 1 ms units.",
                     ParameterType.KNOB_2BYTES, [1, 1099], 1),
        DspParameter(1, "Delay Ratio L", "Adjusts the ratio of the left channel relative to the total delay time.",
                     ParameterType.KNOB, [0, 127], 0),
        DspParameter(2, "Delay Ratio R", "Adjusts the ratio of the right channel relative to the total delay time.",
                     ParameterType.KNOB, [0, 127], 0),
        DspParameter(3, "Delay Level L", "Adjusts the level of the left channel.", ParameterType.KNOB, [0, 127], 0),
        DspParameter(4, "Delay Level R", "Adjusts the level of the right channel.", ParameterType.KNOB, [0, 127], 0),
        DspParameter(5, "Feedback Type", "Selects the feedback type. Stereo: Stereo feedback. Cross: Cross feedback",
                     ParameterType.COMBO, ["Stereo", "Cross"], 0),
        DspParameter(6, "Feedback", "Adjusts the feedback amount.", ParameterType.KNOB, [0, 127], 0),
        DspParameter(7, "High Damp", "Adjusts the high-range damp. A smaller number increases damping.",
                     ParameterType.KNOB, [0, 127], 0),
        DspParameter(8, "Delay Tempo Sync",
        ...
        DspParameter(9, "Input Level", "Adjusts the input level.", ParameterType.KNOB, [0, 127], 0),
        DspParameter(10, "Dry Level", "Adjusts the level of the direct sound.", ParameterType.KNOB, [0, 127], 0),
        DspParameter(11, "Wet Level", "Adjusts the level of the effect sound.", ParameterType.KNOB, [0, 127], 0)
    ]),
