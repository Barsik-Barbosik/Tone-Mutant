...
dsp_effects_tuple: tuple = (
    ...
    DspEffect(18, "Ring Modulator",
              ...
              [DspParameter(1, "OSC Frequency", "Sets the reference frequency of the internal oscillator.",
                            ParameterType.KNOB, [0, 127], 0),
               DspParameter(2, "LFO Rate", "Adjusts the LFO rate.", ParameterType.KNOB, [0, 127], 0),
               DspParameter(3, "LFO Depth", "Adjusts the LFO depth.", ParameterType.KNOB, [0, 127], 0),
    ...
    DspEffect(5, "Reflection",
              ...
              [DspParameter(1, "Wet Level", "Adjusts the level of the effect sound.", ParameterType.KNOB, [0, 127], 0),
               DspParameter(2, "Feedback", "Adjusts the repeat of the reflected sound.", ParameterType.KNOB, [0, 127],
                            0),
               DspParameter(3, "Tone", "Adjusts the tone of the reflected sound.", ParameterType.KNOB, [0, 127], 0),
               DspParameter(4, "Input Level", "Adjusts the input level.", ParameterType.KNOB, [0, 127], 0),
    ...
    DspEffect(19, "Delay",
              ...
              [DspParameter(1, "Delay Time", "Adjusts the total delay time in 1 ms units.",
               ...
               DspParameter(3, "Delay Ratio R",
                            ...
                            ParameterType.KNOB, [0, 127], 0),
               DspParameter(4, "Delay Level L", "Adjusts the level of the left channel.", ParameterType.KNOB, [0, 127],
                            0),
               DspParameter(5, "Delay Level R", "Adjusts the level of the right channel.", ParameterType.KNOB, [0, 127],
                            0),
    ...
    DspEffect(20, "Piano Effect",
              ...
              [DspParameter(1, "Lid Type",
               ...
               DspParameter(2, "Reflection Level", "Adjusts the level of the initial reflection.", ParameterType.KNOB,
                            [0, 127], 0),
              ...
              [DspParameter(1, "Dist Gain", "Adjusts the distortion input signal gain.", ParameterType.KNOB, [0, 127],
               ...
               DspParameter(9, "Amp", "Specifies the amp type.", ParameterType.COMBO,
                            ["Bypass", "FD-PRNST", "FD-TWRV1", "RL-J12", "FD-TWD", "FD-DXRV", "VX-AC3", "ML-DC3",
                             ...
                             "BASS-STK"], 0),
               DspParameter(10, "Wet Level", "Adjusts the level of the effect sound.", ParameterType.KNOB, [0, 127], 0),
    ...
    DspEffect(23, "Drive",
              ...
              [DspParameter(1, "Drive Type", "Selects the drive type.", ParameterType.COMBO,
               ...
               DspParameter(2, "Gain", "Adjusts the driver input signal gain.", ParameterType.KNOB, [0, 127], 0),
    ...
    DspEffect(24, "Amp Cabinet",
              ...
              [DspParameter(1, "Type", "Selects the amp cabinet type.", ParameterType.COMBO,
               ...
               DspParameter(3, "Wet Level", "Adjusts the level of the effect sound.", ParameterType.KNOB, [0, 127], 0),
