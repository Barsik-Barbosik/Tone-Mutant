...
dsp_effects_tuple: tuple = (
    ...
    DspEffect(4, "Enhancer",
              ...
              [DspParameter(1, "Low Frequency", "Adjusts the low range enhancer frequency.",
               ...
               DspParameter(3, "High Frequency", "Adjusts the high range enhancer frequency.", ParameterType.KNOB,
                            [0, 127], 0),
    ...
    DspEffect(11, "Rotary",
              ...
              [DspParameter(1, "Type", "Selects the rotary speaker type.", ParameterType.COMBO,
               ...
               DspParameter(5, "Rise Accel", "Adjusts acceleration when the speed mode is switched from slow to fast.",
                            ParameterType.KNOB, [0, 127], 0),
               DspParameter(6, "Slow Rate", "Adjusts the speaker rotation speed in the slow speed mode.",
                            ParameterType.KNOB, [0, 127], 0),
               DspParameter(7, "Fast Rate", "Adjusts the speaker rotation speed in the fast speed mode.",
                            ParameterType.KNOB, [0, 127], 0),
    ...
    DspEffect(12, "Drive Rotary",
              ...
              [DspParameter(1, "Type", "Selects the rotary speaker type.", ParameterType.COMBO,
               ...
               DspParameter(3, "Overdrive Level", "Adjusts the overdrive output level.", ParameterType.KNOB, [0, 127],
                            0),
               ...
               DspParameter(7, "Rise Accel", "Adjusts acceleration when the speed mode is switched from slow to fast.",
                            ParameterType.KNOB, [0, 127], 0),
               DspParameter(8, "Slow Rate", "Adjusts the speaker rotation speed in the slow speed mode.",
                            ParameterType.KNOB, [0, 127], 0),
               DspParameter(9, "Fast Rate", "Adjusts the speaker rotation speed in the fast speed mode.",
                            ParameterType.KNOB, [0, 127], 0),
