...
dspEffectsTuple: tuple = (
    ...
    DspEffect(19, "Delay", "Delays the input signal and feeds it back to create a repeating effect.", [
        ...
        DspParameter(2, "Delay Ratio L", "Adjusts the ratio of the left channel relative to the total delay time.",
                     ParameterType.KNOB, [0, 127], 0),
        DspParameter(3, "Delay Ratio R", "Adjusts the ratio of the right channel relative to the total delay time.",
                     ParameterType.KNOB, [0, 127], 0),
        DspParameter(4, "Delay Level L", "Adjusts the level of the left channel.", ParameterType.KNOB, [0, 127], 0),
        DspParameter(5, "Delay Level R", "Adjusts the level of the right channel.", ParameterType.KNOB, [0, 127], 0),
        DspParameter(6, "Feedback Type", "Selects the feedback type. Stereo: Stereo feedback. Cross: Cross feedback",
                     ParameterType.COMBO, ["Stereo", "Cross"], 0),
        DspParameter(7, "Feedback", "Adjusts the feedback amount.", ParameterType.KNOB, [0, 127], 0),
        DspParameter(8, "High Damp", "Adjusts the high-range damp. A smaller number increases damping.",
                     ParameterType.KNOB, [0, 127], 0),
        DspParameter(9, "Delay Tempo Sync",
                     ...
                     ParameterType.COMBO, ["Off", "1/4", "1/3", "3/8", "1/2", "2/3", "3/4", "1"], 0),
        DspParameter(10, "Input Level", "Adjusts the input level.", ParameterType.KNOB, [0, 127], 0),
        DspParameter(11, "Dry Level", "Adjusts the level of the direct sound.", ParameterType.KNOB, [0, 127], 0),
        DspParameter(12, "Wet Level", "Adjusts the level of the effect sound.", ParameterType.KNOB, [0, 127], 0)
    ]),
    ...
    DspEffect(30, "Modeling Wah",
              ...
              [DspParameter(1, "Level", "Adjusts the wah level.", ParameterType.KNOB, [0, 127], 0),
               DspParameter(2, "Type", "Selects the wah type.", ParameterType.COMBO,
    ...
    DspEffect(15, "Distortion", "Distortion, wah, and amp simulator combined into a single effect.",
              [DspParameter(1, "Dist Gain", "Adjusts the distortion input signal gain.", ParameterType.KNOB, [0, 127],
                            0),
               DspParameter(2, "Dist Level", "Adjusts the distortion output level.", ParameterType.KNOB, [0, 127], 0),
               DspParameter(3, "Dist Low", "Adjusts the distortion low-range gain.", ParameterType.KNOB, [0, 127], 0),
               DspParameter(4, "Dist High", "Adjusts the distortion high-range gain.", ParameterType.KNOB, [0, 127], 0),
               DspParameter(5, "Wah Type", "Specifies the wah type.", ParameterType.COMBO,
               ...
               DspParameter(6, "Wah Depth",
                            ...
                            ParameterType.KNOB, [-64, 63], 0),
               DspParameter(7, "Wah Manual", "Adjusts the wah filter reference frequency.", ParameterType.KNOB,
                            [0, 127],
                            0),
               DspParameter(8, "Routing", "Specifies the distortion and wah connection.", ParameterType.COMBO,
                            ["Dist", "Wah", "Wah-Dist", "Dist-Wah"], 2),
               DspParameter(9, "Amp", "Specifies the amp type.", ParameterType.COMBO,
                            ["Bypass", "FD-PRNST", "FD-TWRV1", "RL-J12", "FD-TWD", "FD-DXRV", "VX-AC3", "ML-DC3",
                             ...
                             "BASS-STK"], 0),
               DspParameter(10, "Wet Level", "Adjusts the level of the effect sound.", ParameterType.KNOB, [0, 127],
                            0),
               DspParameter(11, "Dry Level", "Adjusts the level of the direct sound.", ParameterType.KNOB, [0, 127],
                            0)]),
    DspEffect(23, "Drive", "Simulates the drive of a musical instrument amplifier.",
              [DspParameter(1, "Drive Type", "Selects the drive type.", ParameterType.COMBO,
                            ["Clean 1", "Clean 2", "Clean 3", "Clean 4",
                             "Crunch 1", "Crunch 2", "Crunch 3", "Crunch 4",
                             "Overdrive 1", "Overdrive 2", "Overdrive 3", "Overdrive 4",
                             "Distortion 1", "Distortion 2", "Distortion 3", "Distortion 4",
                             "Metal 1", "Metal 2", "Metal 3", "Metal 4"], 0),
               DspParameter(2, "Gain", "Adjusts the driver input signal gain.", ParameterType.KNOB, [0, 127],
                            0),
               DspParameter(3, "Level", "Adjusts the drive output level.", ParameterType.KNOB, [0, 127], 0),
               DspParameter(4, "Wet Level", "Adjusts the level of the effect sound.", ParameterType.KNOB, [0, 127],
                            0),
               DspParameter(5, "Dry Level", "Adjusts the level of the direct sound.", ParameterType.KNOB, [0, 127],
                            0)]),
    DspEffect(24, "Amp Cabinet", "Simulates the amp and speaker cabinet without drive and distortion.",
              [DspParameter(1, "Type", "Selects the amp cabinet type.", ParameterType.COMBO,
