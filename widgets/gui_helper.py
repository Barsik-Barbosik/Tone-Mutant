...
class GuiHelper:
    ...
    def init_menu_bar(main_window: QMainWindow):
        ...
        open_action.setStatusTip("Open TON file (Not implemented! Use \"Synchronize Tone\" to load the required tone from the synthesizer.)")
        open_action.setEnabled(False)
        save_action = QAction(QIcon(resource_path('resources/save.png')), "&Save Tone (TON)", main_window)
        save_action.setStatusTip("Save tone as a TON file (Not implemented! Use the synthesizer to save and export the tone.)")
