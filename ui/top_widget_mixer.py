...
class TopWidgetMixer(QWidget):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        frame_layout_upper2 = QGridLayout(frame_upper2)
        frame_layout_upper2.setVerticalSpacing(2)
        frame_layout_upper2.setContentsMargins(10, 10, 10, 5)

        frame_layout_upper2.addWidget(QLabel("<b>UPPER 2</b>"), 0, 0, alignment=Qt.AlignLeft)
        spacer = QSpacerItem(20, 10, QSizePolicy.Expanding, QSizePolicy.Minimum)
        frame_layout_upper2.addItem(spacer, 0, 0)
        ...
        frame_layout_upper2.addWidget(tone_combo_upper2, 0, 1, 1, 2, alignment=Qt.AlignLeft)
        frame_layout_upper2.addWidget(QLabel("Vol:"), 1, 1)
        volume_knob_layout_upper2 = GuiHelper.create_knob_input(self.upper2_volume, self.on_volume_change)
        frame_layout_upper2.addLayout(volume_knob_layout_upper2, 1, 2)
        frame_layout_upper2.addWidget(QLabel("Pan:"), 2, 1)
        pan_knob_layout_upper2 = GuiHelper.create_knob_input(self.upper2_volume, self.on_pan_change)
        frame_layout_upper2.addLayout(pan_knob_layout_upper2, 2, 2)
        self.layout.addWidget(frame_upper2)

        # Block for LOWER 1
        frame_lower1 = QFrame()
        frame_lower1.setObjectName("upper-frame")
        frame_layout_lower1 = QGridLayout(frame_lower1)
        frame_layout_lower1.setVerticalSpacing(2)
        frame_layout_lower1.setContentsMargins(10, 10, 10, 5)

        frame_layout_lower1.addWidget(QLabel("<b>LOWER 1</b>"), 0, 0, alignment=Qt.AlignLeft)
        spacer = QSpacerItem(20, 10, QSizePolicy.Expanding, QSizePolicy.Minimum)
        frame_layout_lower1.addItem(spacer, 0, 0)
        ...
        frame_layout_lower1.addWidget(tone_combo_lower1, 0, 1, 1, 2, alignment=Qt.AlignLeft)
        frame_layout_lower1.addWidget(QLabel("Vol:"), 1, 1)
        volume_knob_layout_lower1 = GuiHelper.create_knob_input(self.lower1_volume, self.on_volume_change)
        frame_layout_lower1.addLayout(volume_knob_layout_lower1, 1, 2)
        frame_layout_lower1.addWidget(QLabel("Pan:"), 2, 1)
        pan_knob_layout_lower1 = GuiHelper.create_knob_input(self.lower1_volume, self.on_pan_change)
        frame_layout_lower1.addLayout(pan_knob_layout_lower1, 2, 2)
        self.layout.addWidget(frame_lower1)

        # Block for LOWER 2
        frame_lower2 = QFrame()
        frame_lower2.setObjectName("upper-frame")
        frame_layout_lower2 = QGridLayout(frame_lower2)
        frame_layout_lower2.setVerticalSpacing(2)
        frame_layout_lower2.setContentsMargins(10, 10, 10, 5)

        frame_layout_lower2.addWidget(QLabel("<b>LOWER 2</b>"), 0, 0, alignment=Qt.AlignLeft)
        spacer = QSpacerItem(20, 10, QSizePolicy.Expanding, QSizePolicy.Minimum)
        frame_layout_lower2.addItem(spacer, 0, 0)
        ...
        frame_layout_lower2.addWidget(tone_combo_lower2, 0, 1, 1, 2, alignment=Qt.AlignLeft)
        frame_layout_lower2.addWidget(QLabel("Vol:"), 1, 1)
        volume_knob_layout_lower2 = GuiHelper.create_knob_input(self.lower2_volume, self.on_volume_change)
        frame_layout_lower2.addLayout(volume_knob_layout_lower2, 1, 2)
        frame_layout_lower2.addWidget(QLabel("Pan:"), 2, 1)
        pan_knob_layout_lower2 = GuiHelper.create_knob_input(self.lower2_volume, self.on_pan_change)
        frame_layout_lower2.addLayout(pan_knob_layout_lower2, 2, 2)
